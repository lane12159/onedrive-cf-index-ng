 ...
 */
//export const obfuscatedClientSecret = `${process.env.CLIENT_SECRET}`
...
module.exports = {
  ...
  clientId: context.env.CLIENT_ID,
  clientSecret: context.env.CLIENT_SECRET,
  obfuscatedClientSecret: context.env.CLIENT_SECRET,
